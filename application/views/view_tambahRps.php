                ...
                <div class="col">
                    <div class="card">
                        <div class="card-header bg-dark">
                            <b class="text-white">Tambah Rps</b>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="norps" aria-describedby="emailHelp" name="norps">
                        </div>
                        <div class="mb-3">
                            <label for="berlaku" class="form-label">Tanggal Berlaku</label>
                            <input type="text" class="form-control" id="berlaku" aria-describedby="emailHelp" name="berlaku">
                        </div>
                        <div class="mb-3">
                            <label for="disusun" class="form-label">Tanggal Disusun</label>
                            <input type="text" class="form-control" id="disusun" aria-describedby="emailHelp" name="disusun">
                        </div>
                        <div class="mb-3">
                            <label for="rev" class="form-label">Revisi</label>
                            <input type="text" class="form-control" id="rev" aria-describedby="emailHelp" name="rev">
                        </div>
                        <div class="mb-3">
                 ...
                 <td style="text-align: center;">
                    E
                        ...
                        <div class="mb-3">
                            ...
                            <textarea type="text" class="form-control" id="gambaran" aria-describedby="emailHelp" name="gambaran"> </textarea>
                        </div>
                        <div class="mb-3">
                            <label for="capaian" class="form-label">Capaian Pembelajaran</label>
                            <textarea type="text" class="form-control" id="capaian" aria-describedby="emailHelp" name="capaian"> </textarea>
                        </div>
                        <div class="mb-3">
                            <label for="prasyarat" class="form-label">Prasyarat Pengetahuan</label>
                            <textarea type="text" class="form-control" id="prasyarat" name="prasyarat"> </textarea>
                        </div>
                        <div class="mb-3">
                ...
                <tr>
                    ...
                    <td></td>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea type="text" class="form-control" id="ref" name="ref"> </textarea>
                        </div>
                        <div class="mb-3">
